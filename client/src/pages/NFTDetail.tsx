              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-gray-800 font-mono text-sm">{nft.contractAddress.substring(0, 10)}...{nft.contractAddress.substring(-8)}</span>
                    <button
                ...
                {nft.creator && (
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-gray-800 font-mono text-sm">{nft.creator.substring(0, 10)}...{nft.creator.substring(-8)}</span>
                      <button

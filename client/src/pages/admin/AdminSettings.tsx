...
export default function AdminSettings() {
  ...
  const [storeName, setStoreName] = useState('Jade Emporium');
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
                ...
                <div className="space-y-4 max-w-lg">
                  ...
                  <div>
                    ...
                    <input type="text" value={fromName} onChange={(e) => setFromName(e.target.value)} placeholder="Jade Emporium" className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm outline-none focus:border-red-400" />
                  </div>

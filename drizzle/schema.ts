...
export const products = mysqlTable("products", {
  ...
  rating: int("rating").default(0), // Store as 0-500 (0-5 stars * 100)
...
export type ThirdwebConfig = typeof thirdwebConfig.$inferSelect;
export type InsertThirdwebConfig = typeof thirdwebConfig.$inferInsert;

// NFT assets table for storing user NFT information
export const nftAssets = mysqlTable("nft_assets", {
  ...
  chainId: varchar("chain_id", { length: 50 }).notNull(), // e.g., "bsc", "ethereum"
...
// NFT transfers table for tracking NFT transfers
